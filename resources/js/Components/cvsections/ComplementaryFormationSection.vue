	...
	<div class="p-6 text-gray-900 dark:text-gray-100">
	    <div class="flex">
	        ...
	        <div class="flex-auto w-1/4 text-right mb-4">
	           ...
	           <button type="button" @click="addNewElement('complementary_formations')" id="btn-add-complementary_formations" class=" focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 dark:disabled:bg-green-700">Nuevo</button>
	       </div>
	   </div>    
	    <div class="my-3 py-2 " v-for="(cfor, index) in complementary_formations" :key="index + 1">
	        <ComplementaryFormationElement                                     
	            ...
	            @complementary_formation-added="enableAddButton"
	            @bd-updated="updateDB"
	        />
	    </div>
	</div>	
